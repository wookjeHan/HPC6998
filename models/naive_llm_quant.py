...
class Naive_LLM_Quant(nn.Module):
    def __init__(self, model_name, model_kwargs={}, tok_kwargs={}, device='cuda'):
        super(Naive_LLM_Quant, self).__init__()
        self.device = device
        # Load Model
        self.transformers = AutoModelForCausalLM.from_pretrained(model_name, **model_kwargs, torch_dtype=torch.bfloat16)
